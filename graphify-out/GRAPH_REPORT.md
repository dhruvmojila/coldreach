...
## Corpus Check
- 85 files · ~58,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1206 nodes · 3188 edges · 52 communities detected
- Extraction: 42% EXTRACTED · 58% INFERRED · 0% AMBIGUOUS · INFERRED: 1855 edges (avg confidence: 0.62)
...
Cohesion: 0.04
Nodes (87): find(), find_stream(), _finder_config(), FindRequest, _resolve(), root(), _sse_event(), _stream_find() (+79 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (98): _build_sources(), cache_clear(), cache_list(), _find_with_progress(), ColdReach local API server.  Exposes a FastAPI application on localhost:8765 so, Parameters for single-email verification., Build FinderConfig from an API request., Format a single Server-Sent Event frame. (+90 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (77): verify(), check_catchall(), clear_cache(), is_catch_all(), _probe_via_reacher(), _random_local(), Catch-all domain detection.  A "catch-all" mail server accepts RCPT TO for ANY a, Return True/False/None for catch-all status.      Convenience wrapper around :fu (+69 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (57): Store *result* for *domain* in all available cache layers., Delete cached entries.          Parameters         ----------         domain:, Return all cached domains as (domain, cached_at, is_expired) tuples., Return basic cache statistics., Return a cached DomainResult for *domain*, or ``None`` on miss/expiry., _extract_domain_from_ddg_html(), Company name → primary domain resolver.  Strategy (tried in order, stops on firs, Query Clearbit Autocomplete for the company domain. (+49 more)
...
Cohesion: 0.06
Nodes (32): SpiderFoot source — CLI runner via docker exec.  Runs sf.py inside the ``coldrea, Parse sf.py JSON output, returning domain-filtered email list., Run a SpiderFoot passive scan via ``docker exec`` and collect emails.      Requi, Run sf.py inside the container via docker exec, return domain emails., SpiderFootSource, _json_file(), _make_proc(), Unit tests for coldreach.sources.harvester  docker exec / subprocess calls are m (+24 more)
...
Cohesion: 0.06
Nodes (38): ABC, status(), version(), fetch(), Abstract base class for all ColdReach email discovery sources.  Every source fol, Safe wrapper around :meth:`fetch` — never raises.          Returns the results l, Execution summary for one source run., SourceSummary (+30 more)
...
Cohesion: 0.08
Nodes (36): checkServerOnline(), findEmails(), resolveCompany(), handleUse(), _make_commit(), _mock_json_response(), Unit tests for coldreach.sources.github  All HTTP calls are mocked., test_deduplicates_same_email_across_commits() (+28 more)
...
- **Why does `EmailSource` connect `Community 0` to `Community 1`, `Community 3`, `Community 5`, `Community 7`, `Community 10`, `Community 12`, `Community 14`, `Community 15`, `Community 16`, `Community 19`, `Community 22`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `find_emails()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `run_basic_pipeline()` connect `Community 2` to `Community 1`, `Community 3`, `Community 7`, `Community 9`, `Community 11`, `Community 13`, `Community 17`?**
